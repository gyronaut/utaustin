...
void intUSRatioPlotEff(TString filename){
    gStyle->SetOptStat(0);
    gStyle->SetOptFit(0);
    gStyle->SetErrorX(0);
    ...
    TH1D* hPhidphi_0_20 = getHisto(filename, "AvgUSsubhPhi2Dpeak", "Eff_0_20", -1.2, 1.2, kRed+2, 22);
...
*/
    ...
    TH1F* hphiyieldSyst_0_20 = new TH1F("hphiyieldSyst_0_20", "hphiyieldSyst_0_20", 1000, 0.5E-03, 1.55E-02);
    //TH1F* hphiyieldSyst_20_50 = new TH1F("hphiyieldSyst_20_50", "hphiyieldSyst_20_50", 1000, 0.5E-03, 1.55E-02);
    //TH1F* hphiyieldSyst_50_100 = new TH1F("hphiyieldSyst_50_100", "hphiyieldSyst_50_100", 1000, 0.5E-03, 1.55E-02);
    ...
    TH1F* hphinearyieldSyst_0_20 = new TH1F("hphinearyieldSyst_0_20", "hphinearyieldSyst_0_20", 1000, 0.5E-04, 1.55E-03);
    //TH1F* hphinearyieldSyst_20_50 = new TH1F("hphinearyieldSyst_20_50", "hphinearyieldSyst_20_50", 1000, 0.5E-04, 1.55E-03);
    //TH1F* hphinearyieldSyst_50_100 = new TH1F("hphinearyieldSyst_50_100", "hphinearyieldSyst_50_100", 1000, 0.5E-04, 1.55E-03);
    ...
    TH1F* hphiawayyieldSyst_0_20 = new TH1F("hphiawayyieldSyst_0_20", "hphiawayyieldSyst_0_20", 1000, 0.5E-04, 1.55E-03);
    //TH1F* hphiawayyieldSyst_20_50 = new TH1F("hphiawayyieldSyst_20_50", "hphiawayyieldSyst_20_50", 1000, 0.5E-04, 1.55E-03);
    //TH1F* hphiawayyieldSyst_50_100 = new TH1F("hphiawayyieldSyst_50_100", "hphiawayyieldSyst_50_100", 1000, 0.5E-04, 1.55E-03);
...
*/
    TFile* output = new TFile(Form("yieldsyst_%s.root", filename), "RECREATE");
