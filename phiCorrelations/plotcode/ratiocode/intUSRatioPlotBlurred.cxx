...
TF1* setupFit(TString fitname, TH1D* hist, Int_t color, Int_t linestyle){
    ...
    /*if(fitname == "corrFit"){
        ...
        basefit->FixParameter(0, 1.69976E-01 - 3.03144E-04);
...
void intUSRatioPlotBlurred(TString outputstring = "garbage"){
    gStyle->SetOptStat(0);
    gStyle->SetOptFit(0);
    gStyle->SetErrorX(0);
    ...
    TH1D* hPhidphi_0_20 = getHisto("~/phiStudies/results_onlineeff/Combined/US_syst_trig_4_8_assoc_2_4_effcorr_hPhi_0_20_combined.root", "hPhi", "AvgUSsubhPhi2Dpeak", "Eff_0_20", -1.2, 1.2, kRed+2, 22);
   ...
   //20-50 section 
    ...
    TH1D* hPhidphi_20_50 = getHisto("~/phiStudies/results_onlineeff/Combined/US_syst_trig_4_8_assoc_2_4_effcorr_hPhi_20_50_Combined.root", "hPhi", "AvgUSsubhPhi2Dpeak", "Eff_20_50", -1.2, 1.2, kRed+2, 22);
    ...
    TH1D* hPhidphi_50_100 = getHisto("~/phiStudies/results_onlineeff/Combined/US_syst_trig_4_8_assoc_2_4_effcorr_hPhi_50_80_combined.root", "hPhi", "AvgUSsubhPhi2Dpeak", "Eff_50_80", -1.2, 1.2, kRed+2, 22);
    ...
    Double_t multBlurArray[3] = {20.0, 65.0, 100.0};
    ...
    //"blur" the actual ratios with estimated systematics
    for(int i = 0; i < 3; i++){
        nearArrayErr[i] += nearArray[i]*0.1;
        awayArrayErr[i] += awayArray[i]*0.1;
        bulkArrayErr[i] += bulkArray[i]*0.04;
        totalArrayErr[i] += totalArray[i]*0.02;
    }
    ...
    TGraphErrors* ratiosNear = new TGraphErrors(3, multBlurArray, nearArray, multArrayErr, nearArrayErr);
    ratiosNear->SetMarkerStyle(20);
    ratiosNear->SetMarkerSize(2);
    ratiosNear->SetMarkerColor(kRed+1);
    ratiosNear->SetLineColor(kRed+2);
    ratiosNear->SetFillColor(kRed+1);
    ratiosNear->SetFillStyle(3144);
    ...
    TGraphErrors* ratiosNearSyst = new TGraphErrors(3, multBlurArray, nearArray, multArrayErr, nearArraySystErr);
    ...
    TGraphErrors* ratiosAway = new TGraphErrors(3, multBlurArray, awayArray, mult2ArrayErr, awayArrayErr);
    ratiosAway->SetMarkerStyle(21);
    ratiosAway->SetMarkerSize(2);
    ratiosAway->SetMarkerColor(kBlue+1);
    ratiosAway->SetLineColor(kBlue+2);
    ratiosAway->SetFillColor(kBlue+1);
    ratiosAway->SetFillStyle(3144);
    ...
    TGraphErrors* ratiosBulk = new TGraphErrors(3, multBlurArray, bulkArray, multArrayErr, bulkArrayErr);
    ratiosBulk->SetMarkerStyle(22);
    ratiosBulk->SetMarkerSize(2);
    ratiosBulk->SetMarkerColor(kGreen+2);
    ratiosBulk->SetLineColor(kGreen+3);
    ratiosBulk->SetFillColor(kGreen+2);
    ratiosBulk->SetFillStyle(3144);
    ratiosBulk->SetLineWidth(2);
   
    TGraphErrors* ratiosTot = new TGraphErrors(3, multBlurArray, totalArray, multArrayErr, totalArrayErr);
    ...
    ratiosTot->SetFillColor(kMagenta+2);
    ratiosTot->SetFillStyle(1001);
    ...
    ratiosMultlegend->AddEntry(ratiosBulk, "Underlying Event", "f");
    ratiosMultlegend->AddEntry(ratiosAway, "Away-side (Jet)", "f");
    ratiosMultlegend->AddEntry(ratiosNear, "Near-side (Jet)", "f");
    ...
    ratioNearHist->GetYaxis()->SetRangeUser(0.0, 0.02);
