...
void intUSRatioPlotsyst(TString outputstring, TString input_0_20 = "", TString input_20_50 = "", TString input_50_80 = "", TString scaleSuffix = "avgscale", Int_t bgMethod=0){
    ...
    if(input_0_20.EqualTo("")) input_0_20 = "~/phiStudies/results_onlineeff/Combined/checkbinedge/US_syst_trig_4_8_assoc_2_4_effcorr_hPhi_0_20_combined.root";
    if(input_20_50.EqualTo("")) input_20_50 = "~/phiStudies/results_onlineeff/Combined/checkbinedge/US_syst_trig_4_8_assoc_2_4_effcorr_hPhi_20_50_combined.root";
    if(input_50_80.EqualTo("")) input_50_80 = "~/phiStudies/results_onlineeff/Combined/checkbinedge/US_syst_trig_4_8_assoc_2_4_effcorr_hPhi_50_80_combined.root";
    ...
    Double_t near0_20hPhiYield = hPhidphi_0_20->IntegralAndError(1,8,near0_20hPhiError) - hphiBG->GetParameter(0)*8.0;
    //near0_20hPhiError = TMath::Sqrt(TMath::Power(near0_20hPhiError, 2) + TMath::Power(6.0*mid0_20hPhiError, 2));
    Double_t near0_20hhYield = hhdphi_0_20->IntegralAndError(1,8,near0_20hhError) - hhBG->GetParameter(0)*8.0;
   ...
   //20-50 section 
    ...
    Double_t near20_50hPhiYield = hPhidphi_20_50->IntegralAndError(1,8,near20_50hPhiError) - hphiBG_20_50->GetParameter(0)*8.0;
    //near20_50hPhiError = TMath::Sqrt(TMath::Power(near20_50hPhiError, 2) + TMath::Power(6.0*mid20_50hPhiError, 2));
    Double_t near20_50hhYield = hhdphi_20_50->IntegralAndError(1,8,near20_50hhError) - hhBG_20_50->GetParameter(0)*8.0;
    ...
    Double_t near50_100hPhiYield = hPhidphi_50_100->IntegralAndError(1,8,near50_100hPhiError) - hphiBG_50_100->Integral(hPhidphi_50_100->GetXaxis()->GetBinLowEdge(1), hPhidphi_50_100->GetXaxis()->GetBinUpEdge(8));
    //near50_100hPhiError = TMath::Sqrt(TMath::Power(near50_100hPhiError, 2) + TMath::Power(6.0*mid50_100hPhiError, 2));
    Double_t near50_100hhYield = hhdphi_50_100->IntegralAndError(1,8,near50_100hhError) - hhBG_50_100->Integral(hPhidphi_50_100->GetXaxis()->GetBinLowEdge(1), hPhidphi_50_100->GetXaxis()->GetBinUpEdge(8));
    //near50_100hhError = TMath::Sqrt(TMath::Power(near50_100hhError, 2) + TMath::Power(6.0*mid50_100hhError, 2));
    Double_t away50_100hPhiYield = hPhidphi_50_100->IntegralAndError(9,16,away50_100hPhiError) - hphiBG_50_100->Integral(hPhidphi_50_100->GetXaxis()->GetBinLowEdge(9), hPhidphi_50_100->GetXaxis()->GetBinUpEdge(16));
    //away50_100hPhiError = TMath::Sqrt(TMath::Power(away50_100hPhiError, 2) + TMath::Power(8.0*mid50_100hPhiError, 2));
    Double_t away50_100hhYield = hhdphi_50_100->IntegralAndError(9,16,away50_100hhError)- hhBG_50_100->Integral(hPhidphi_50_100->GetXaxis()->GetBinLowEdge(9), hPhidphi_50_100->GetXaxis()->GetBinUpEdge(16));
    ...
    TPaveText *text2 = new TPaveText(0.670, 0.207, 0.929, 0.345, "NDC");
