...
TH1D* getHisto(TString filename, TString histotype, TString histoname, TString mult, Float_t etamin, Float_t etamax, Int_t color, Int_t markerstyle){
    ...
    TH1D* histo1D = (TH1D*)histo2D->ProjectionY(histoname1D.Data(), histo2D->GetXaxis()->FindBin(etamin+eps), histo2D->GetXaxis()->FindBin(etamax-eps));
...
void intUSRatioPlotsingletrig(TString outputstring){
    gStyle->SetOptStat(0);
    gStyle->SetOptFit(0);
    gStyle->SetErrorX(0);
    ...
    TH1D* hhdphi_0_20 = getHisto("~/phiStudies/results_onlineeff/FAST/singletrig/trig_4_8_assoc_2_4_effcorr_hh_0_20.root", "hh", "hh2D", "Eff_0_20", -1.2, 1.2, kBlue+2, 21);
    ...
    TH1D* hPhidphi_0_20 = getHisto("~/phiStudies/results_onlineeff/FAST/singletrig/US_syst_trig_4_8_assoc_2_4_effcorr_hPhi_0_20_singletrig.root", "hPhi", "AvgUSsubhPhi2Dpeakavgscale", "Eff_0_20", -1.2, 1.2, kRed+2, 22);
   ...
   //20-50 section 
    ...
    TH1D* hhdphi_20_50 = getHisto("~/phiStudies/results_onlineeff/FAST/singletrig/trig_4_8_assoc_2_4_effcorr_hh_20_50.root", "hh", "hh2D", "Eff_20_50", -1.2, 1.2, kBlue+2, 21);
    ...
    TH1D* hPhidphi_20_50 = getHisto("~/phiStudies/results_onlineeff/FAST/singletrig/US_syst_trig_4_8_assoc_2_4_effcorr_hPhi_20_50_singletrig.root", "hPhi", "AvgUSsubhPhi2Dpeakavgscale", "Eff_20_50", -1.2, 1.2, kRed+2, 22);
    ...
    TH1D* hhdphi_50_100 = getHisto("~/phiStudies/results_onlineeff/FAST/singletrig/trig_4_8_assoc_2_4_effcorr_hh_50_80.root", "hh", "hh2D", "Eff_50_80", -1.2, 1.2, kBlue+2, 21);
    ...
    TH1D* hPhidphi_50_100 = getHisto("~/phiStudies/results_onlineeff/FAST/singletrig/US_syst_trig_4_8_assoc_2_4_effcorr_hPhi_50_80_singletrig.root", "hPhi", "AvgUSsubhPhi2Dpeakavgscale", "Eff_50_80", -1.2, 1.2, kRed+2, 22);
