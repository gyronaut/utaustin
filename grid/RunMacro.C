 ...
 *  RunMacro.C
 *  ================================
 *  File used to start a batch/grid analysis, contains all of the
 *  necessary parameters to launch on the grid (aliroot creates a jdl file
 *  automatically).
 *
 *  It loads the necessary libraries, splits up the specified run numbers, then
 *  launches the AliAnalysisTaskQA.cxx code on each of the nodes.
 *
 *  Run with: aliroot -b -q RunMacro.C 
 */
