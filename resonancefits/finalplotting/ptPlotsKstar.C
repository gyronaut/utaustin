void ptPlotsKstar(){
    TFile *file1 = new TFile("20170721_Kstar0_masswidth_recon_pf100_scaled.root");
    TH1D* single1 = (TH1D*)file1->Get("ptbin21particle3");
    single1->SetLineColor(1);
    single1->SetMarkerStyle(21);
    single1->SetMarkerSize(0.5);
    single1->SetLineWidth(3);
    TH1D* othersingle1 = (TH1D*)file1->Get("ptbin05particle3");
    othersingle1->SetLineColor(1);
    othersingle1->SetMarkerStyle(21);
    othersingle1->SetMarkerSize(0.5);
    othersingle1->SetLineWidth(3);
    TF1* fit1 = (TF1*)single1->GetFunction("fitPTbin2100particle3");
    TF1* otherfit1 = (TF1*)othersingle1->GetFunction("fitPTbin500particle3");
    ...
    TFile *file2 = new TFile("20170721_Kstar0_masswidth_recon_pf100_scaled_error05.root");
    TH1D* single2 = (TH1D*)file2->Get("ptbin21particle3");
    single2->SetLineColor(17);
    single2->SetFillColor(17);
    single2->SetLineWidth(3);
    TH1D* othersingle2 = (TH1D*)file2->Get("ptbin05particle3");
    othersingle2->SetLineColor(17);
    othersingle2->SetFillColor(17);
    othersingle2->SetLineWidth(3);
    TF1* fit2 = (TF1*)single2->GetFunction("fitPTbin2100particle3");
    TF1* otherfit2 = (TF1*)othersingle2->GetFunction("fitPTbin500particle3");
    ...
    TFile *file3 = new TFile("20170721_Kstar0_simplewidth_recon_pf100_scaled_error05.root");
    TF1* fit3 = (TF1*)file3->Get("fitPTbin2100particle3");
    fit3->SetLineColor(4);
    fit3->SetLineStyle(7);
    fit3->SetLineWidth(4);
    TF1* otherfit3 = (TF1*)file3->Get("fitPTbin500particle3");
    otherfit3->SetLineColor(4);
    otherfit3->SetLineStyle(7);
    otherfit3->SetLineWidth(4);

    TFile *file5 = new TFile("20170721_Kstar0_fixedwidth42_recon_pf100_scaled_error05.root");
    TF1* fit5 = (TF1*)file5->Get("fitPTbin2100particle3");
    fit5->SetLineColor(2);
    fit5->SetLineStyle(3);
    fit5->SetLineWidth(5);
    TF1* otherfit5 = (TF1*)file5->Get("fitPTbin500particle3");
    otherfit5->SetLineColor(2);
    otherfit5->SetLineStyle(3);
    otherfit5->SetLineWidth(5);

    //KStar0 AT DECAY //
    TFile *decayfile1 = new TFile("20170721_Kstar0_masswidth_pf160_scaled.root");
    TH1D* decaysingle1 = (TH1D*)decayfile1->Get("ptbin21particle4");
    decaysingle1->SetLineColor(1);
    decaysingle1->SetMarkerStyle(21);
    decaysingle1->SetMarkerSize(0.5);
    decaysingle1->SetLineWidth(3);
    TH1D* otherdecaysingle1 = (TH1D*)decayfile1->Get("ptbin05particle4");
    ...
    TF1* decayfit1 = (TF1*)decaysingle1->GetFunction("fitPTbin2100particle4");
    TF1* otherdecayfit1 = (TF1*)otherdecaysingle1->GetFunction("fitPTbin500particle4");
    ...
    TFile *decayfile2 = new TFile("20170721_Kstar0_masswidth_pf160_scaled_error05.root");
    TH1D* decaysingle2 = (TH1D*)decayfile2->Get("ptbin21particle4");
    decaysingle2->SetLineColor(17);
    decaysingle2->SetFillColor(17);
    decaysingle2->SetLineWidth(3);
    TH1D* otherdecaysingle2 = (TH1D*)decayfile2->Get("ptbin05particle4");
    otherdecaysingle2->SetLineColor(17);
    otherdecaysingle2->SetFillColor(17);
    otherdecaysingle2->SetLineWidth(3);
    TF1* decayfit2 = (TF1*)decaysingle2->GetFunction("fitPTbin2100particle4");
    TF1* otherdecayfit2 = (TF1*)otherdecaysingle2->GetFunction("fitPTbin500particle4");
    decayfit2->SetLineColor(kGreen-2);
    decayfit2->SetLineStyle(5);
    decayfit2->SetLineWidth(5);
    otherdecayfit2->SetLineColor(kGreen-2);
    otherdecayfit2->SetLineWidth(5);
    otherdecayfit2->SetLineStyle(5);

    TFile *decayfile3 = new TFile("20170721_Kstar0_simplewidth_pf160_scaled_error05.root");
    TF1* decayfit3 = (TF1*)decayfile3->Get("fitPTbin2100particle4");
    decayfit3->SetLineColor(4);
    decayfit3->SetLineStyle(7);
    decayfit3->SetLineWidth(5);
    TF1* otherdecayfit3 = (TF1*)decayfile3->Get("fitPTbin500particle4");
    otherdecayfit3->SetLineColor(4);
    otherdecayfit3->SetLineStyle(7);
    otherdecayfit3->SetLineWidth(5);

    TFile *decayfile5 = new TFile("20170721_Kstar0_fixedwidth42_pf160_scaled_error05.root");
    TF1* decayfit5 = (TF1*)decayfile5->Get("fitPTbin2100particle4");
    decayfit5->SetLineColor(2);
    decayfit5->SetLineStyle(3);
    decayfit5->SetLineWidth(5);
    TF1* otherdecayfit5 = (TF1*)decayfile5->Get("fitPTbin500particle4");
    ...
    TCanvas *cSingle = new TCanvas("single", "single", 70, 70, 1000, 800);
    ...
    TLegend *singleLegend = new TLegend(0.1683, 0.06993, 0.9739, 0.9358);
    ...
    singleLegend->SetTextSizePixels(30);

    TLegend *singleLegend2 = new TLegend(0.1723, 0.4000, 0.5210, 0.4555);
    ...
    singleLegend2->SetTextSizePixels(34); 
    ...
    text2->AddText("K*^{0} at Decay Point");
    ...
    //othersingle1->GetYaxis()->SetMaxDigits(2);
    ...
    otherdecaysingle1->GetXaxis()->SetNdivisions(509);
    ...
    othertext2->AddText("K*^{0} at Decay Point");
    othertext2->AddText("0.4 < p_{T} < 0.6 GeV/c");
    othertext2->SetBorderSize(0);
    othertext2->SetFillStyle(0);
    othertext2->GetLine(1)->SetTextSizePixels(32);
    othertext2->GetLine(0)->SetTextSizePixels(36);
    ...
    //othersingleLegend->SetTextAlign(22);
    ...
    //othersingleLegend2->SetTextAlign(22);
