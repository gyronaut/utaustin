...
/*
    TFile *file4 = new TFile("20170522_KKbarAdded2_reconsimplewidth_recon_pf100_error01.root");
...
*/
    ...
    /*
    TFile *file6 = new TFile("20170522_KKbarAdded2_reconfixedwidth_recon_pf100_error10.root");
    ...
    TFile *file7 = new TFile("20170522_KKbarAdded2_reconfixedwidth70_recon_pf100_scaled.root");
...
*/
    ...
    masstext->AddText("(K*^{0} + #bar{K}*^{0}) Mass");
   ...
   //width7->Draw("SAME P E1");
    ...
    widthtext->AddText("(K*^{0} + #bar{K}*^{0}) Width");
