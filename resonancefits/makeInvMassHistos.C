...
int makeInvMassHistos(){
    ...
    TFile *output = new TFile("output_invm_bggaus_relBW_noPS_simplewidthfixed_2017_03_01.root", "RECREATE");
...
*/
            ...
            TF1 *fit = new TF1(Form("fitPTbin%d00particle%d", nfile*2+1, i), FitFunRelBW, 0.75, 1.1, 4);
